        ...
        <div style={{minHeight:'100vh',background:'var(--bg)',overflowY:'auto'}}>
          ...
          <div style={{maxWidth:480,margin:'0 auto',padding:'16px 24px 0'}}>
            ...
            <div style={{textAlign:'center',marginBottom:40}}>
              <div style={{fontFamily:'var(--fd)',fontSize:40,fontWeight:900,color:'var(--tx1)',lineHeight:1.1,letterSpacing:'-0.5px',marginBottom:12}}>Send USDC<br/><span style={{color:'var(--ac)'}}>GL<span className="ap-spin-earth" aria-hidden="true" style={{width:32,height:32,verticalAlign:"middle",marginLeft:4,marginRight:4}}></span>BALLY.</span></div>
