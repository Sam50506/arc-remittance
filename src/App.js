...
const loadContractHistory=useCallback(async()=>{if(!address)return;try{
  ...
  const { invPayer, setInvPayer, invAmt, setInvAmt, invDesc, setInvDesc, invCtry, setInvCtry, invId, setInvId, payDet, setPayDet, handleCreateInv, handlePayInv, handlePayInvReview } = useInvoices({ address, signer, provider, setStatus, setLoading, setTxns, awardCashback, refreshBal, payId, setPayId, cleanErr });
