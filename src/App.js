...
const renderContacts = () => <ContactsPage contacts={contacts} setContacts={setContacts} txns={txns} setTab={setTab} setSendTo={setSendTo} setSendCtry={setSendCtry} setStatus={setStatus} cName={cName} setCName={setCName} cAddr={cAddr} setCAddr={setCAddr} cCtry={cCtry} setCCtry={setCCtry} cSearch={cSearch} setCSearch={setCSearch} editId={editId} setEditId={setEditId} showAdd={showAdd} setShowAdd={setShowAdd} manageContacts={manageContacts} setManageContacts={setManageContacts} selectedContacts={selectedContacts} setSelectedContacts={setSelectedContacts}/>;
