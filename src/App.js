...
function AppInner() {
  ...
  useEffect(()=>{if(tab==='history'&&signer)loadContractHistory();},[tab,signer,loadContractHistory]);useEffect(()=>{if(tab==='rewards'&&address)fetchMyClaims();},[tab,address]);
